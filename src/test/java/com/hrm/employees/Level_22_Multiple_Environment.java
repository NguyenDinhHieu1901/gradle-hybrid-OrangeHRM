...
public class Level_22_Multiple_Environment extends BaseTest {
	...
	public void beforeClass(String browserName) {
		String envGradle = System.getProperty("envGradle");
		
		ConfigFactory.setProperty("env", envGradle);
		environment = ConfigFactory.create(Environment.class);

		driver = getBrowserDriver(browserName, environment.getApplicationUrl());
		log.info("Env Gradle: " + envGradle);
		log.info("Current URL: " + driver.getCurrentUrl());
		log.info("Username: " + environment.getApplicationUserName());
		log.info("Password: " + environment.getApplicationPassword());
